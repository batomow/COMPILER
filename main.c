...
int main(){ 
    DIM dimension1 = NewDIM(), dimension2 = NewDIM();  
    SetDIM(&dimension1, 3, 1); 
    SetDIM(&dimension2, 1, 1); 
    VarTable table1 = NewVarTable(10); 
    InsertVar(&table1, "Carlos", TableInt, 5000, dimension1); 
    InsertVar(&table1, "Ian", TableFloat, 5001, dimension2); 
    InsertVar(&table1, "Ina", TableChar, 5002, dimension1); 
    InsertVar(&table1, "Cristhel", TableDouble, 5002, dimension1); 
    InsertVar(&table1, "Tom", TableInt, 5002, dimension1); 
    table1.print(&table1); 
    //DestroyTable(&table1); 
    return 0; 
}
